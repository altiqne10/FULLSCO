...
- **نسبة الترحيل الإجمالية**: 35% (الصفحات الأساسية والمكونات الرئيسية وصفحات المنح الدراسية وصفحة الاتصال)
...
| الصفحة | المسار | الحالة | ملاحظات |
|--------|--------|--------|---------|
| قائمة التصنيفات | `/categories` | ✅ تم | |
| تفاصيل التصنيف | `/categories/[slug]` | ✅ تم | |
| قائمة الدول | `/countries` | ✅ تم | |
| تفاصيل الدولة | `/countries/[slug]` | ✅ تم | |
...
| التصنيفات | `/api/categories` | ✅ تم | |
| الدول | `/api/countries` | ✅ تم | |
| المستويات | `/api/levels` | ⚠️ لم يكتمل | |
