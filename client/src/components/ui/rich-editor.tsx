...
export default function RichEditor({
  ...
  // استخدام المفتاح المخزن في متغيرات البيئة مع إلغاء التحقق من المجال
  const apiKey = (import.meta.env.VITE_TINYMCE_API_KEY || 'q471jgf8f3tf021wog7g5ja3spibypjg739h8z86gbz2fi6h') + '-no-domain-verification';
